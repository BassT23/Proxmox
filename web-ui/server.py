...
<head>
  ...
  <style>
    ...
    * { box-sizing:border-box } .visually-hidden { position:absolute; width:1px; height:1px; padding:0; margin:-1px; overflow:hidden; clip:rect(0,0,0,0); white-space:nowrap; border:0 } body { margin:0; min-height:100vh; color:var(--text); background:radial-gradient(circle at top right,#1e3567 0,var(--bg) 42rem) }
    ...
    .interactive-terminal-panel { margin-top:18px; padding:20px; border:1px solid #159cf055; border-radius:16px; background:linear-gradient(145deg,#07182be8,#061323e8); box-shadow:0 18px 60px #0008 } .interactive-terminal-panel[hidden] { display:none } .interactive-terminal { min-height:24em; max-height:calc(100vh - 280px); overflow:auto; padding:10px; border:1px solid #159cf055; border-radius:9px; background:#050914; } .interactive-terminal .xterm { height:24em; min-width:80ch; } .interactive-terminal-actions { display:flex; align-items:center; justify-content:flex-end; gap:8px; flex-wrap:wrap; margin-top:12px } .interactive-terminal .xterm-viewport { overflow-y:auto !important; }
...
<body>
  ...
  <main class="app-main" id="dashboard" hidden>
    ...
    <section id="interactive-terminal-panel" class="interactive-terminal-panel" hidden aria-live="polite"><div class="section-title"><div><h2>Interactive terminal</h2><span id="interactive-terminal-title" class="hint"></span></div><span id="interactive-terminal-status" class="pill warn">Disconnected</span></div><div id="interactive-terminal" class="interactive-terminal" aria-label="Interactive job terminal"></div><div id="interactive-terminal-message" class="management-message" hidden></div><div class="interactive-terminal-actions"><button id="interactive-terminal-detach" type="button">Detach</button><a id="interactive-terminal-download" class="job-download" href="#" download>Download full log</a></div></section>
    </section>
