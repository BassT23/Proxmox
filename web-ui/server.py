...
<body>
  ...
  <script>
    ...
    const helpContent={
      'Target filters':[
        'The preview shows the targets that would be included in the next check based on the current inventory and ONLY/EXCLUDE filters.',
        'Opening or changing the preview does not contact any target.',
        'ONLY has priority; EXCLUDE is ignored while ONLY is set.'
      ]
    };
