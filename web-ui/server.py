...
<head>
  ...
  <style>
    ...
    * { box-sizing:border-box } .visually-hidden { position:absolute; width:1px; height:1px; padding:0; margin:-1px; overflow:hidden; clip:rect(0,0,0,0); white-space:nowrap; border:0 } body { margin:0; min-height:100vh; color:var(--text); background:radial-gradient(circle at top right,#1e3567 0,var(--bg) 42rem) }
    ...
    .page-nav { display:flex; flex-wrap:wrap; gap:7px; margin-top:18px; padding-top:14px; border-top:1px solid var(--line) } .page-nav a { color:var(--muted); border:1px solid transparent; border-radius:9px; padding:7px 11px; font-size:.78rem; text-decoration:none } .page-nav a:hover,.page-nav a:focus-visible { color:var(--text); border-color:var(--line); outline:2px solid #73a7ff55 } .page-nav a.active { color:var(--text); background:#73a7ff1c; border-color:#73a7ff88; font-weight:700 } .button { display:inline-flex; align-items:center; justify-content:center; border:1px solid var(--line); border-radius:9px; padding:9px 12px; color:var(--text); background:#ffffff0d; cursor:pointer; font:inherit; font-size:.82rem; text-decoration:none } .button.primary { background:#73a7ff24; border-color:#73a7ff88 }
