...
header_nav = '<button class="nav-toggle" type="button" aria-label="Open navigation" aria-expanded="false">☰</button><nav class="page-nav" aria-label="Primary"><a href="/" data-page="overview">Dashboard</a><a href="/settings" data-page="settings">Settings</a><a href="/scheduler" data-page="scheduler">Scheduler</a></nav>'
