...
PAGE = PAGE.replace('</style>', '<style>.dashboard-kpis .metric { display:flex; flex-direction:column; gap:7px; } .dashboard-kpis .metric-top { display:flex; align-items:center; justify-content:space-between; gap:8px; min-width:0; } .overview-summary-icon { display:inline-flex; flex:0 0 28px; width:28px; height:28px; align-items:center; justify-content:center; color:inherit; } .overview-summary-icon .status-icon { width:28px; height:28px; min-width:28px; min-height:28px; stroke-width:1.8; }</style></head>', 1)
