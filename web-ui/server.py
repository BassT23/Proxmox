...
<body>
  ...
  <script>
    ...
    const configGroups=[
      ...
      {title:'Containers / LXC',hint:'Choose which LXC guests and lifecycle states are included.',columns:[['CHECK_WITH_LXC','CHECK_RUNNING_CONTAINER','CHECK_STOPPED_CONTAINER'],['LXC_START_DELAY','BACKUP_LXC_MP']]},
      {title:'Virtual Machines',hint:'Choose which VMs and lifecycle states are included.',columns:[['CHECK_WITH_VM','CHECK_RUNNING_VM','CHECK_STOPPED_VM','CHECK_PAUSED_VM'],['VM_START_DELAY']]},
