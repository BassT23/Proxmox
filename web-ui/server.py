...
<body>
  ...
  <script>
    ...
    const configGroups=[
      ...
      {title:'Containers / LXC',hint:'Choose which LXC guests and lifecycle states are included for checks and updates.',columns:[['CHECK_WITH_LXC','CHECK_RUNNING_CONTAINER','CHECK_STOPPED_CONTAINER','WITH_LXC','RUNNING_CONTAINER','STOPPED_CONTAINER'],['LXC_START_DELAY','BACKUP_LXC_MP']]},
      {title:'Virtual Machines',hint:'Choose which VMs and lifecycle states are included for checks and updates.',columns:[['CHECK_WITH_VM','CHECK_RUNNING_VM','CHECK_STOPPED_VM','CHECK_PAUSED_VM','WITH_VM','RUNNING_VM','STOPPED_VM'],['VM_START_DELAY']]},
