...
<body><main>
  ...
  <script>
    ...
    function rememberLogScroll(node){if(suppressLogScroll)return;const distance=node.scrollHeight-node.scrollTop-node.clientHeight;logAutoFollow=distance<=LOG_BOTTOM_TOLERANCE;logScrollTop=node.scrollTop}
