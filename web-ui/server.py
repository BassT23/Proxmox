...
<head>
  ...
  <style>
    ...
    * { box-sizing:border-box } .visually-hidden { position:absolute; width:1px; height:1px; padding:0; margin:-1px; overflow:hidden; clip:rect(0,0,0,0); white-space:nowrap; border:0 } body { margin:0; min-height:100vh; color:var(--text); background:radial-gradient(circle at top right,#1e3567 0,var(--bg) 42rem) }
    ...
    .check-update-matrix { display:grid; grid-template-columns:minmax(0,1fr) 58px 58px; border:1px solid #94a3b81f; border-radius:10px; overflow:hidden; background:#0b122433 } .matrix-row { display:contents } .matrix-label,.matrix-cell { min-width:0; padding:7px 8px; border-bottom:1px solid #94a3b815 } .matrix-label { color:var(--text); font-size:.76rem; overflow-wrap:anywhere } .matrix-cell { display:grid; place-items:center } .matrix-head { color:var(--muted); font-size:.68rem; font-weight:700; text-align:center } .matrix-row:last-child > * { border-bottom:0 } .matrix-control { width:fit-content; margin:0; color:var(--muted) } .matrix-control .field-label { position:absolute; width:1px; height:1px; overflow:hidden; clip:rect(0,0,0,0); white-space:nowrap } .matrix-control input[type=checkbox] { margin:0 } .matrix-empty { color:var(--muted); font-size:.8rem } .matrix-extras { display:flex; flex-wrap:wrap; align-items:center; gap:8px 24px; margin-top:10px } .matrix-extra-row { display:flex; flex:0 0 auto; align-items:center; gap:8px; min-width:0; color:var(--muted); font-size:.78rem } .delay-label { flex:0 0 auto; white-space:nowrap } .delay-control { display:inline-flex; flex:0 0 auto; align-items:center; gap:5px } .delay-control input[type=number] { width:76px; min-width:0; padding:6px 8px; border:1px solid var(--line); border-radius:8px; color:var(--text); background:#0b1224; font:inherit } .delay-control .field-unit { white-space:nowrap; color:var(--muted); font-size:.7rem } .matrix-extras > .boolean-field { width:fit-content; flex:0 0 auto; max-width:100% }
    @media (max-width:760px) { .check-update-matrix { grid-template-columns:minmax(0,1fr) 54px 54px } .matrix-extras { flex-direction:column; align-items:flex-start; gap:6px } .matrix-extra-row { flex-wrap:wrap } }
    .node-group .group-header { display:grid; grid-template-columns:32px minmax(0,1fr); grid-template-rows:auto auto; align-items:center; gap:7px 10px; min-height:0 } .node-group .group-toggle { grid-column:1; grid-row:1 / span 2 } .node-group .group-title { grid-column:2; grid-row:1; min-width:0; align-self:end } .node-group .group-title strong { white-space:normal; overflow-wrap:anywhere } .node-group .group-title small { white-space:normal; overflow-wrap:anywhere } .node-group .group-summary { grid-column:2; grid-row:2; display:flex; flex-wrap:wrap; justify-content:flex-start; gap:6px; min-width:0; white-space:normal } .node-group .group-summary .node-details { margin-left:0; justify-self:auto } .node-group .group-summary .node-action { min-width:0 } .config-field.boolean-field { width:fit-content; max-width:100%; justify-self:start; cursor:pointer } .config-field.boolean-field:hover { color:var(--text) }
