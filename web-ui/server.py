...
<body>
  ...
  <script>
    ...
    const interactiveAttached=new Set(),interactiveAttachments=new Map(),interactiveQueues=new Map(),finalOutputLoaded=new Set(),finalOutputLoading=new Set();let interactiveTerminal=null;
