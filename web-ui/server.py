...
<body>
  ...
  <main class="app-main" id="dashboard" hidden>
    ...
    <section class="management-grid">
      ...
      <section class="management-panel" id="internal-ssh-panel"><div class="section-title"><div><h2>Internal SSH Connections</h2><span class="hint">Used for other Proxmox nodes and internal guests when automatic access is not enough. Nodes are detected automatically. External systems are managed separately under External Targets.</span></div></div><div class="settings-group"><h3>Proxmox Nodes</h3><div id="internal-ssh-nodes"><div class="empty">Loading…</div></div></div><div class="settings-group"><h3>Virtual Machines</h3><div id="internal-ssh-vms"><div class="empty">Loading…</div></div><button type="button" class="internal-ssh-add" data-ssh-add="vm">+ Add VM SSH connection</button></div><div class="settings-group"><h3>LXC Containers</h3><div id="internal-ssh-lxcs"><div class="empty">Loading…</div></div><button type="button" class="internal-ssh-add" data-ssh-add="lxc">+ Add LXC SSH connection</button></div><div id="internal-ssh-message" class="management-message"></div></section>
