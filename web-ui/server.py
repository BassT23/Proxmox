...
PAGE = PAGE.replace('</head>', '<style>.pill.security-warn{display:inline-flex;width:max-content;max-width:100%;white-space:nowrap}.pill .status-icon,.reboot-required-badge .status-icon{flex:0 0 auto}.main-body>#settings-page:not([hidden]){margin-top:0;padding-top:24px}.target-selection-controls{display:flex;gap:6px;align-items:flex-end;margin-right:4px}.target-selection-column{display:flex;flex-direction:column;align-items:center;gap:2px;min-width:34px}.target-selection-label{display:block;color:var(--muted);font-size:.62rem;line-height:1}.target-selection-state{box-sizing:border-box;display:inline-flex;align-items:center;justify-content:center;width:34px;min-width:34px;height:34px;min-height:34px;padding:0;border:1px solid var(--line);border-radius:7px;background:transparent;color:var(--muted);font-weight:700;line-height:1}.target-selection-state.only{color:#75e6a1;border-color:#75e6a1}.target-selection-state.exclude{color:#ff8b8b;border-color:#ff8b8b}.target-selection-state:focus-visible{outline:2px solid var(--accent);outline-offset:2px}.target-selection-header{display:grid;grid-template-columns:minmax(0,1fr) auto auto auto;align-items:center;gap:8px;margin:0 12px;padding:7px 12px 3px;color:var(--muted);font-size:.68rem;text-align:center}.target-selection-header span:first-child{text-align:left}.target-selection-header span:last-child{text-align:right}.target-selection-legend{color:var(--muted)}@media(max-width:620px){.target-selection-header{display:none}.target-selection-controls{gap:5px;margin-right:0}}</style></head>', 1)
