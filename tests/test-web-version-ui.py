...
assert '<p class="login-account-hint">Sign in with your Proxmox administrator account.</p>' in module.PAGE
...
assert 'Sign in with your Proxmox administrator account.' in login_markup
